...
export const TABLES: Partial<Table>[] = [
  ...
  { id: 6, number: 6, category: "Card Games" },
  { id: 7, number: 7, category: "Card Games" },
  { id: 8, number: 8, category: "Card Games" },
  ...
  { id: 13, number: 13, category: "Ping Pong" },
  { id: 14, number: 14, category: "Ping Pong" },
  { id: 15, number: 15, category: "Ping Pong" },
];
